...
#
cd /root
# wget https://dl.grafana.com/oss/release/grafana_6.7.3_amd64.deb -O /tmp/grafana.deb
wget https://dl.grafana.com/oss/release/grafana_7.0.0_amd64.deb -O /tmp/grafana.deb
