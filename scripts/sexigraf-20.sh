...
DEBIAN_FRONTEND=noninteractive apt-get -y install xml-twig-tools genisoimage collectd lib32z1 build-essential uuid uuid-dev libssl-dev libxml2  sysstat snmp memcached net-tools
